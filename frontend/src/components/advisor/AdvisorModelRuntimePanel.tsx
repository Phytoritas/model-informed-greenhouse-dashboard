...
const AdvisorModelRuntimePanel = ({
    ...
    const copy = locale === 'ko'
        ? {
            title: '모델 런타임',
            subtitleReady: '제한된 시나리오 + 국소 민감도',
            subtitleFallback: '모니터링 우선 런타임',
            noRuntime: '이번 응답에는 모델 런타임 블록이 아직 없습니다.',
            statusReady: '시나리오 연동',
            statusFallback: '모니터링 우선',
            stateTitle: '현재 모델 상태',
            ...
            missing: '누락 필드',
            recommended: '추천',
            compareEmpty: '아직 강한 bounded 옵션이 정렬되지 않았습니다.',
            yield7d: '7일 수확',
            yield14d: '14일 수확',
            energy: '에너지',
            balanceDelta: '균형 회복',
