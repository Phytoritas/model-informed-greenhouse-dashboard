...
export default function TopBar({
  ...
  return (
    <header className="px-4 pt-4 sm:px-6 xl:px-8">
      <div className="sg-glass mx-auto flex max-w-[1640px] flex-col gap-4 rounded-[28px] px-5 py-4 lg:min-h-[80px] lg:flex-row lg:items-center lg:justify-between">
        <div className="flex min-w-0 items-center gap-4 lg:w-[380px]">
        ...
        <div className="hidden min-w-0 flex-1 px-6 lg:block">
          <div className="mx-auto max-w-[440px]">
            <Input aria-label={copy.search} placeholder={copy.search} className="h-11 rounded-full bg-white/78" />
          </div>
        </div>
