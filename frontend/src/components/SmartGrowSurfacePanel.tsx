...
export default function SmartGrowSurfacePanel({
    ...
    const copy = locale === 'ko'
        ? {
            title: 'SmartGrow 도구 런처',
            subtitle: `${cropLabel} 운영에서 바로 실행할 수 있는 안전 계산기와 추천 도구입니다.`,
            loading: 'SmartGrow 도구를 불러오는 중입니다...',
            unavailable: 'SmartGrow 도구 정보를 아직 불러오지 못했습니다.',
            pendingParser: '일부 참고 문서 파싱이 아직 진행 중입니다.',
            ready: '준비됨',
            unavailableStatus: '대기',
            empty: '아직 연결된 SmartGrow 도구가 없습니다.',
            pesticide: '농약 검토',
            nutrient: '양액 레시피',
            ...
            pendingLead: '입력 계약 또는 문서 연결이 더 필요한 surface만 따로 표시합니다.',
            parserLead: '지식 문서 파싱이 끝나면 추천 설명 범위가 넓어집니다.',
        ...
        : {
            title: 'SmartGrow Tool Launcher',
            subtitle: `Open the bounded operating tools for ${cropLabel}.`,
            loading: 'Loading SmartGrow tools...',
            unavailable: 'SmartGrow tool information is unavailable.',
            ...
            pendingLead: 'Only surfaces that still need input contracts or source links stay in the support lane.',
            parserLead: 'Knowledge coverage expands after source parsing finishes.',
