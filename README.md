...
- The frontend is moving to a new SmartGrow Command Center shell with a glass top bar, workspace navigation, hero control narrative, live metric strip, action-first today board, and denser decision snapshot cards while preserving the existing optimizer, advisor, weather, market, and knowledge surfaces.
